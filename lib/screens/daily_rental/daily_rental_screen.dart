...
// import 'package:habitatgn/widgets/reservation/daily_rental_modal.dart';
...
//         child: InkWell(
//           onTap: () {
//             print('Tapped on rental⛪⛪🤬🤬🤬🤬🤬🤬: ${rental.id}');

//             Navigator.push(
//               context,
//               MaterialPageRoute(
//                 builder: (context) => HouseDetailScreen(houseId: rental.id),
//               ),
//             );
//           },
//           borderRadius: BorderRadius.circular(16),
...
//                         onPressed: () => _showBookingModal(context, rental),
...
// ============================================
// Modal de filtre (DailyRentalFilterModal)
// ============================================
class DailyRentalFilterModal extends StatefulWidget {
  ...
  final Function(
      ...
      int minGuests,
      DateTime? checkIn,
      DateTime? checkOut) onApplyFilter;
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: ['Tous', 'Maison', 'Appartement', 'Villa', 'Studio']
                    .map((type) => FilterChip(
                          label: Text(type),
